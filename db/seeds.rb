...
Schedule.create!(time: "08:00", date: "2018-01-22", price: 50000, film: Film.find_by(name: "Tam sinh tam the"))
Schedule.create!(time: "10:00", date: "2018-01-26", price: 50000, film: Film.find_by(name: "Tam sinh tam the"))
Schedule.create!(time: "12:00", date: "2018-01-21", price: 50000, film: Film.find_by(name: "Tam sinh tam the"))
Schedule.create!(time: "14:30", date: "2018-01-23", price: 50000, film: Film.find_by(name: "Tam sinh tam the"))
Schedule.create!(time: "15:50", date: "2018-01-23", price: 50000, film: Film.find_by(name: "Tam sinh tam the"))
Schedule.create!(time: "18:00", date: "2018-01-23", price: 50000, film: Film.find_by(name: "Tam sinh tam the"))
Schedule.create!(time: "20:00", date: "2018-01-23", price: 50000, film: Film.find_by(name: "Tam sinh tam the"))
Schedule.create!(time: "22:10", date: "2018-01-23", price: 50000, film: Film.find_by(name: "Tam sinh tam the"))
Schedule.create!(time: "12:00", date: "2018-01-24", price: 50000, film: Film.find_by(name: "Vikings Season 5 (2017)"))
Schedule.create!(time: "14:30", date: "2018-01-24", price: 50000, film: Film.find_by(name: "Vikings Season 5 (2017)"))
Schedule.create!(time: "15:50", date: "2018-01-23", price: 50000, film: Film.find_by(name: "Vikings Season 5 (2017)"))
Schedule.create!(time: "18:00", date: "2018-01-29", price: 50000, film: Film.find_by(name: "Family Time (2017)"))
Schedule.create!(time: "20:00", date: "2018-01-23", price: 50000, film: Film.find_by(name: "Family Time (2017)"))
Schedule.create!(time: "22:10", date: "2018-01-23", price: 50000, film: Film.find_by(name: "Family Time (2017)"))
